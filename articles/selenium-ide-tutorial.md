...
published: true
published_at: 2018-12-14 09:00
---

**内容を2019年版に更新した記事を作成しました！**
**[Selenium IDEで「はじめよう自動化」ver.2019](https://zenn.dev/takeya0x86/articles/selenium-ide-tutorial-2019)**
...
![selenium-ide-02](/images/2018/12/14/02_selenium-ide.png =309x)

つづいて、このテストプロジェクトの名前を入力します。

![selenium-ide-03](/images/2018/12/14/03_selenium-ide.png =309x)
...
![selenium-ide-05](/images/2018/12/14/05_selenium-ide.png =309x)
